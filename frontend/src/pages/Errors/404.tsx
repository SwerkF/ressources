    ...
    <section className="">
      <div className="mx-auto w-full bg-white max-w-7xl px-5 py-16 md:px-10 md:py-20">
        <div className="grid items-center gap-8 sm:gap-20 lg:grid-cols-2">
          <div>
            <h1 className="mb-4 text-4xl font-bold md:text-6xl">Erreur 404</h1>
            <p className="mb-6 max-w-lg text-sm text-gray-500 sm:text-xl md:mb-10 lg:mb-12">
              Oh non ! La page que vous cherchez n'existe pas. Veuillez vérifier
              l'URL et réessayer. En attendant, voici la photo d'un chat.
            </p>
            <a
              onClick={() => navigate("/")}
