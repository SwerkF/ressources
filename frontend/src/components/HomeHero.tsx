...
const HomeHero = () => {
    ...
    const handleSubmit = (e:any) => {
        e.preventDefault();
        navigate(`/ressources?search=${search}`);
    }
            ...
            <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
                <div className="text-center">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-gray-900/20">
                                ...
                                <div className="flex-[0_0_auto]">
                                    <button type="submit" className="size-[46px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" onClick={handleSubmit}>
                    ...
                    <div className="mt-10 sm:mt-20">
                        <HomeFilterCard title="Videos" link="/ressources?category=videos" icon={<PlayCircle size={24} />} />
                        <HomeFilterCard title="Articles" link="/ressources?category=articles" icon={<Newspaper size={24} />} />
                        <HomeFilterCard title="Courses" link="/ressources?category=courses" icon={<Book size={24} />} />
                        <HomeFilterCard title="Design" link="/ressources?category=design" icon={<DiamondsFour size={24} />} />
                        <HomeFilterCard title="Code" link="/ressources?category=code" icon={<Code size={24} />} />
                        <HomeFilterCard title="Database Ressources" link="/ressources?category=database" icon={<Database size={24} />} />
                    </div>
                </div>
            </div>
        </div>
